...
\begin{document}
    ...
    %Basic configuration
    \title{Analisis Perbandingan Model Neural Network dengan Arsitektur
Judul
Temporal Fusion Transformer dan Varian LSTM dalam Prediksi
Pergerakan Harga Saham pada setiap Tier pada Pasar Modal
Indonesia}
    \date{}
    \author{
