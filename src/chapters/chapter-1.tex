...
, dan jumlah perusahaan dari berbagai sektor yang menawarkan sahamnya kian meningkat.
    ...
    \begin{figure}[H]
        ...
        \caption{Peningkatan Jumlah Investor di Indonesia. Sumber: \parencite{asiavesta2022}}  
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \caption{Peningkatan Jumlah Perusahaan di Pasar Modal. Sumber: \parencite{asiavesta2022}}
...
\item Penelitian ini dilakukan pada \textit{device} Laptop Lenovo Legion 5 15IMH05.
\end{enumerate}
